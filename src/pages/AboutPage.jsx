        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12">
            {companyStats.map((stat, i) => {
              const icons = [Award, Clock, TrendingUp, Shield];
              ...
              return (
                <div key={i} className="text-center group">
                  ...
                  <div className="text-sm font-semibold text-navy-950/70">
                    {stat.label}
                  </div>
                </div>
              );
                  ...
                  {member.image ? (
                    ...
                    <div className="w-full h-80 bg-gray-100 flex items-center justify-center">
                      <div className="text-center">
                        <div className="w-20 h-20 bg-navy-950/10 rounded-full flex items-center justify-center mx-auto mb-3">
                          <span className="text-2xl font-bold text-navy-950/30">
                            {member.name.charAt(1) === '[' ? '?' : member.name.charAt(0)}
                          </span>
                        </div>
                        <p className="text-gray-400 text-xs">Photo pending</p>
                      </div>
                    </div>
                  )}
                </div>
